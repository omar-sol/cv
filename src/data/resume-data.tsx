...
export const RESUME_DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:"• Fine-tuned pre-trained AI models (text-to-image and LLMs) for various applications using Hugging Face libraries (Diffusers, PEFT, Transformers) and cloud computing instances (AWS, GCP)\n\n• Deployed models to cloud services and developed REST APIs (FastAPI). I also provided internal demos (Gradio Python library) for internal evaluation, facilitating feedback and iterative improvement.\n\n• I participated in designing and developing applications of machine learning algorithms for new products, including a color palette generator (a generative model using a GAN) and a color extraction tool from images (k-means).\n\n• Participated in data acquisition (web scraping, labeling) and data processing (cleaning, filtering) activities to develop new models.\n\n• Collaborated with cross-functional teams to define project requirements and deliverables.\n\n• Conducted research to stay up-to-date on the latest AI advancements and actively shared insights with the team to identify and explore creative solutions relevant to the Startup.", 
    },
    // {
    //   company: "Jojo Mobile",
